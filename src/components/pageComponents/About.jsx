...
const About = () => {
  return (
    <div>
      <h1>Who am I?</h1>
      <p>A recent bootcamp grad of DevMountain Dallas where I learned the fundamentals of Javascript front-end and back-end development. 
      <br />
      ...
      <h3>My Stacks</h3>
      <p> JavaScript | HTML5 | Git | CSS | Node | ReactJS | Redux | Express | Bootstrap </p>
    </div>
  )
}
